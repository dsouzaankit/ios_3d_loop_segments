...
Install via **TestFlight** or sideload (**SideStore nightly** preferred when AltStore flakes; else **AltStore**; Sideloadly last) with a free or paid Apple ID — see [ios/BUILD-WITHOUT-MAC.md](ios/BUILD-WITHOUT-MAC.md).
