...
struct ExportView: View {
    ...
    private var exportsFolderSection: some View {
        Section("Exports folder") {
            ...
            Text(
                "Active: loop/op_00|01.mp4, _working.mp4, _vanilla_download.*. Archive: pCloud basename[_3D_*]<time>. Finish copies to archive/; root stays on LAN. Stop/new export moves to archive/. " +
