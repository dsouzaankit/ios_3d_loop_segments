...
| **Search in Browse** / **Copy name** | Failed resume **and** **Unavailable**: copy the filename, or fill the Browse search bar and run the same pipeline. Unavailable drops the stale exact-name cache first so a move can still match. |
