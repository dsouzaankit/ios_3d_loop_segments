...
| `-SkipWifiWwwProbeOnQuit` | Do not POST `/wifi_www_probe.json` before Home (default: on-device Wi‑Fi-only www check; on fail bounce the phone LAN AP via `-BouncePhoneLanAp`) |
